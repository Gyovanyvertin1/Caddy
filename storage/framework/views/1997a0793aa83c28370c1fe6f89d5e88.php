...
<div class="p-5 mt-12 w-full max-w-xl flex flex-col items-center inter">
    ...
    <?php $__errorArgs = ['startingPlace'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 py-2"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <button wire:loading.delay.attr="disabled" <?php if(!$startingPlace): ?> disabled <?php endif; ?> wire:click="next()" class="active:opacity-30 transition duration-150 disabled:opacity-30 disabled:cursor-not-allowed bg-green-custom text-white font-bold py-2 px-4 rounded w-full">Next</button>
...
<?php /**PATH C:\xampp\htdocs\caddy-master\resources\views/livewire/wizard-steps/select-places.blade.php ENDPATH**/ ?>